...
# hyperparameter
parser.add_argument(
    "--lambda_kd", type=float, default=0.2, help="trade-off parameter for kd loss"
)
parser.add_argument(
    "--feat_dim", type=int, default=128, help="dimension of the projection space"
)
parser.add_argument(
    "--nce_n",
    type=int,
...
parser.add_argument(
    "--nce_mom", type=float, default=0.5, help="momentum for non-parametric updates"
)

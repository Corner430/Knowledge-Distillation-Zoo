...
def main():
    ...
    translator = define_translator(
        in_channels_s, in_channels_t, args.k, use_bn, args.cuda
    )
    ...
    optimizer_para = torch.optim.SGD(
    ...
    optimizer = torch.optim.SGD(
        chain(snet.parameters(), translator.parameters()),
        lr=args.lr,
        momentum=args.momentum,
        weight_decay=args.weight_decay,
        nesterov=True,

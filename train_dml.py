...
parser.add_argument(
    "--net1_init", type=str, required=True, help="initial parameters of net1"
)
parser.add_argument(
    "--net2_init", type=str, required=True, help="initial parameters of net2"
)
...
parser.add_argument(
    "--net1_name", type=str, required=True, help="name of net1"
)  # resnet20/resnet110
parser.add_argument(
    "--net2_name", type=str, required=True, help="name of net2"
)  # resnet20/resnet110
        ...
        if i % args.print_freq == 0:
            log_str = (
                ...
                "prec2@5:{top25.val:.2f}({top25.avg:.2f})".format(
                    ...
                    data_time=data_time,
                    cls1_losses=cls1_losses,
                    kd1_losses=kd1_losses,
                    top11=top11,
                    top15=top15,
                    cls2_losses=cls2_losses,
                    kd2_losses=kd2_losses,
                    top21=top21,
                    top25=top25,
                )
            )
...
def test(test_loader, nets, criterions):
    ...
    logging.info(
        "Cls1: {:.4f}, KD1: {:.4f}, Prec1@1: {:.2f}, Prec1@5: {:.2f}"
